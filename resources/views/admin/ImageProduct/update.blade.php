...
@section('content')
    ...
    <form class="needs-validation" action="{{ route('page_admin.product.processUpdate', ['id'=>$product->id]) }}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="summary" id="summary"  rows="3" required>{{$product->summary}}</textarea>
        </div>
        <div class="form-group">
